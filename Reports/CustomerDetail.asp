...
<%
    ...
    Connection.Open "DSN=WIN2012;UID=sa;PWD=@Rinama011;Database=CreditPlus"
...
<style>
<!-- #Include File=".\Content\style.css" -->
</style>
...
<%
    mRs.Open "exec Rabo_WWW_GetCustomersDeals " & CustomerId,Connection
...
<tr <% if count mod 2 = 0 then Response.Write "id=EvenRow" else Response.Write "id=OddRow"%>>
	...
	<td align="Right"><% =ccur(mRs("PositionValue")) %></td>	
</tr>
